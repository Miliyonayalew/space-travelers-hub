...
- [📖 Space Travelers Hub <a name="about-project"></a>](#-space-travelers-hub-)
...
**Space Travelers Hub is a project that used real live data from the `SpaceX API`. The task is to build a web application for a company that provides commercial and scientific space travel services. The application will allow users to book rockets, join selected space missions and leave or cancel reservation.**
...
- **Book rocket**
- **Join Selected Space Mission**
- **Cancel or Leave Rocket Reservation and Mission Member**
